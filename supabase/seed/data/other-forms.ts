...
export const i131a: ApplicationTypeSeed = {
  slug: 'travel-document-carrier-documentation',
  form_code: 'I-131A',
  name: 'Replace a Green Card While Abroad (Travel Documentation)',
...
export const i134: ApplicationTypeSeed = {
  slug: 'declaration-of-financial-support',
  form_code: 'I-134',
  name: 'Declare Financial Support for a Visitor',
...
export const i821: ApplicationTypeSeed = {
  ...
  eligibility_overview: 'Your country of nationality must have an active TPS designation, and you must meet the residence/presence dates for that designation.',
  workflow_overview: 'We confirm your country and dates, then prepare your I-821 and checklist.',
  sections: [
    { key: 'eligibility', title: 'Eligibility Basics', questions: [{ key: 'tps_country', prompt: 'What country are you a national of?', type: 'text', required: true, is_eligibility_question: true }, { key: 'continuous_residence_date', prompt: 'Since what date have you continuously resided in the United States?', type: 'date', required: true, is_eligibility_question: true }] },
...
export const i821d: ApplicationTypeSeed = {
  slug: 'daca-request',
  form_code: 'I-821D',
  name: 'Request DACA (Deferred Action for Childhood Arrivals)',
  ...
  eligibility_overview: 'Eligibility depends on age at arrival, continuous residence, education status, and no disqualifying criminal history.',
...
export const n565: ApplicationTypeSeed = {
  ...
  form_code: 'N-565',
  name: 'Replace a Citizenship Certificate',
  short_name: 'Replace Citizenship/Naturalization Document',
  goal_categories: ['citizenship-documents'],
